...
the paused, generation-checked native proof, which now has
[29 passing hosted cases](../../docs/research/2026-09-11-native-secret-lifecycle-proof.md).
The AWS implementation documented
