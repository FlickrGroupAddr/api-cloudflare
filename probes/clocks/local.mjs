...
const mf=new Miniflare({modules:true,script:await readFile(config.bundle,"utf8"),compatibilityDate:"2026-07-30",compatibilityFlags:["nodejs_compat"],host:"127.0.0.1",port:0,cf:false,logRequests:false,telemetry:{enabled:false},d1Databases:["DB"],durableObjects:{COORD:{className:"ProbePartitionWake",useSQLite:true}},bindings:{...config.vars,PROOF_TOKEN:process.env.FGA_CLOCK_TOKEN},
